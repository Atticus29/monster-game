...
public class Community {
  ...
  public List<Person> getPersons() {
    String sqlCommand = "SELECT persons.* FROM communities_persons JOIN persons ON (persons.id = communities_persons.person_id) WHERE communities_persons.community_id =:communityid;";
