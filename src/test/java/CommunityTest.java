...
public class CommunityTest {
  ...
  public void getPersons_returnsAllPersons_List() {
    ...
    Person testPerson = new Person("Henry", "henry@henry.com");
    testPerson.save();
    Person testPerson2 = new Person("Henryaaaa", "henrsdfay@henry.com");
    testPerson2.save();
    Person testPerson3 = new Person("Henryddf", "henradfgy@henry.com");
    testPerson3.save();
    testCommunity.addPerson(testPerson);
    testCommunity.addPerson(testPerson2);
    testCommunity.addPerson(testPerson3);
    List savedPersons = testCommunity.getPersons();
    assertEquals(savedPersons.size(), 3);
  }
